...
- **The four groups have crisp definitions** (sidebar order, top-to-bottom):
  ...
  - **Compositions** — domain/game components built from atoms (the Reference Entity family, Choice Groups, Class Ability Tree, Roll Table, Entity Grid/Row, Content, App Bar, Footer, Static Entity Content, Nav Drawer).
