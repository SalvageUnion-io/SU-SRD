 ...
 * site `srd` and the `in-the-union-now` builder). It owns the container
 ...
 *
 * Data-source agnostic (per component-lib conventions): the brand is described
...
const CONTAINER_CLASS =
  'flex items-center gap-[14px] bg-su-ink-dark px-5 py-3 z-50 border-b-entity border-su-orange-dark sm:px-[34px] sm:py-[14px]'
...
type HeaderShellProps = {
   ...
   * framework component's root, so srd passes the name here instead.
   */
