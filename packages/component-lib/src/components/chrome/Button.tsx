 ...
 * `primary` (rust — THE action color), `ghost`, `danger` variants and the
 * canonical `full`/`compact`/`mini` size rungs (styles/sizing.ts). An
 * optional leading `glyph` (e.g. '⚄ Roll') renders
