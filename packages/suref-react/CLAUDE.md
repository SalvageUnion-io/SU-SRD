...
- **The four groups have crisp definitions** (sidebar order, top-to-bottom):
  ...
  - **Atoms** — indivisible primitives: one job, compose no other atom (Text, Stamp, Slab, Badge, Button, Tooltip, Glyph, Vital Gauge, Stat Display, Condition Swatch, Inline Ref/Edit Field, Slot Grid, Activation Cost, Sheet Display, Field, Panel).
