...
- **The four groups have crisp definitions** (sidebar order, top-to-bottom):
  ...
  - **Containers** — content-agnostic wrappers / state shells that hold or announce arbitrary content (Display Card — the container primitive — Modal, Inset, Banner, Toast, Empty State, Skeleton, Card Skeleton, Section Card).
