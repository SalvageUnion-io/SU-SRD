...
export function ConditionChip({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1.5 rounded-[2px] border-[1.5px] border-ink px-2 py-[3px] font-cond text-[11px] font-semibold uppercase leading-none',
    ...
    <div className={cn('flex flex-wrap items-center gap-1.5', className)}>
      ...
      {onAdd && (
        <button
          type="button"
          onClick={onAdd}
          className="inline-flex cursor-pointer items-center rounded-[2px] border-[1.5px] border-dashed border-wk-faint px-2 py-[3px] font-cond text-[11px] font-semibold uppercase leading-none text-wk-muted hover:border-ink hover:text-ink"
        >
          + Add
        </button>
      )}
