...
export const StepBtn = forwardRef<HTMLButtonElement, StepBtnProps>(function StepBtn(
  ...
  return (
    <button
      ...
      type={type}
      className={cn(
        'inline-flex h-6 w-6 min-h-11 min-w-11 cursor-pointer items-center justify-center rounded-[3px] border-chrome border-ink bg-paper font-body text-[15px] font-bold leading-none text-ink hover:bg-[var(--ground,var(--color-wk-bg-2))] focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-rust/25 disabled:pointer-events-none disabled:opacity-40 sm:min-h-0 sm:min-w-0',
        className
      )}
      {...props}
    />
