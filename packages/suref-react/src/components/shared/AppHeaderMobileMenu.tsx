  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger
        render={
          <button
            ...
            className="flex items-center justify-center rounded-md p-1.5 text-su-paper transition-colors hover:text-paper focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-su-orange"
          >
      ...
      <Dialog.Portal>
        ...
        <Dialog.Popup className="fixed inset-y-0 right-0 z-50 flex w-72 max-w-[85vw] flex-col bg-paper p-4 shadow-lg data-[closed]:animate-slide-out-right data-[open]:animate-slide-in-right">
          ...
          <div className="mb-4 flex items-center justify-between">
            <span className="inline-flex shrink-0 border border-su-black font-cond text-sm font-bold uppercase leading-none tracking-tight">
              <span className="bg-su-black px-1.5 py-1 text-paper">In the Union</span>
              <span className="bg-paper px-1.5 py-1 text-su-black">Now</span>
            </span>
            <Dialog.Close
              render={
                <button
