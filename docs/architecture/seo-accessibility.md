...
**2. Static HTML** (`StaticEntityContent` — `apps/srd/src/components/StaticEntityContent.tsx`, rendered from `apps/srd/src/components/EntityView.tsx`):
