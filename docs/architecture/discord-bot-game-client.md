...
| `/su sheet`     | `botClient.sheet`                                                            | ephemeral + _Post to channel_ | "Lean over and look at their sheet." Ephemeral because reading is private; shareable because sometimes the table should see it.           |
