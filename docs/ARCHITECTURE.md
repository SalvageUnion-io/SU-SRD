...
This document provides a high-level overview of the SURef application architecture, data flow, and key patterns.
...
3. Start dev server
4. Hot reload updates UI

## Build Process

1. Install dependencies (`bun install`)
2. Generate types and validate data
3. Build app (`bun run build`)
4. Output: `dist/client/` for deployment
...
- Generated types from reference module schemas
- Relative imports for cleaner file relationships
