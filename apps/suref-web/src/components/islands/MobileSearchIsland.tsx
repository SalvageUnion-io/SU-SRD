    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger
        render={
          ...
          <button
            className="flex size-11 items-center justify-center rounded-md text-su-white"
      ...
      <Dialog.Portal>
        ...
        <Dialog.Popup className="fixed inset-x-0 top-0 z-50 flex flex-col gap-3 bg-su-white p-4 shadow-lg data-[open]:animate-slide-in-right data-[closed]:animate-slide-out-right">
