...
/**
 * Playwright configuration for suref-web end-to-end tests.
 *
 * suref-web is a fully static Astro site (output: 'static', no SSR, no
...
export default defineConfig({
  ...
  // webServer.cwd defaults to this config file's directory (apps/suref-web),
