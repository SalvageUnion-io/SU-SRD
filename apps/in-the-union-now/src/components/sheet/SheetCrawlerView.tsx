/**
 * SheetCrawlerView — the crawler branch of the live sheet (extracted from
 * Sheet.tsx, audit item 19). Hero = TL identity + SP/Bays trackers + economy
 * lozenges (UPKEEP/UPGRADE/TRADE, the R-4 action entry points); rail =
 * docked mech + lead pilot; body = CrawlerSheet. Owns the economy-dialog
 * state (it was hoisted to Sheet only because the branch wasn't a component).
 */
...
type SheetCrawlerViewProps = SheetViewCommonProps & { crawler: Crawler }

export function SheetCrawlerView({
  crawler,
  composition,
  wired,
  back,
