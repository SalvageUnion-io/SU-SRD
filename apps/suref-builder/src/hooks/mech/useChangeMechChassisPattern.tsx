...
export function useChangeMechChassisPattern(id: string | undefined, confirm: ConfirmFn) {
  ...
  return useCallback(
    ...
    [id, selectedChassis, systems, modules, deleteEntity, createEntity, updateMech, confirm]
  )
}
