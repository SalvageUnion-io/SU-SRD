...
import { Heading, Text, Card, EntityDisplay } from '../../chakra'
import { useConfirmDialog, useAlertDialog } from '../shared/ConfirmDialog'
...
function TreeSection({
  ...
  const { handleAddAbility, handleRemoveAbility } = useManagePilotAbilities(id, confirm, showAlert)
  const allAbilities = useMemo(() => SalvageUnionReference.Abilities.all(), [])
