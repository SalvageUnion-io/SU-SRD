...
- [`docs/adrs/`](docs/adrs/) — architecture decision records (16 ADRs; most reflect decisions live in the code, ADR-015/016 record a governing target). Consult the matching ADR before revisiting a prior decision (e.g. [ADR-015](docs/adrs/ADR-015-itun-surface-taxonomy.md) — the **governing** surface/mode taxonomy for where a rule is enforced — and [ADR-007](docs/adrs/ADR-007-automation-boundary.md) automation boundary before building rules-driven features).
